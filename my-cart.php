...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('Su carrito ha sido actualizada');</script>";
		}
	}
...
?>
								<div class="reviews">
									( <?php echo htmlentities($num);?> Vistas )
								</div>
								<?php } ?>
							</div>
						</div><!-- /.row -->
...
<div class="form-group">
					    <label class="info-title" for="Billing Address"> Dirección de envío<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">País  <span>*</span></label>
