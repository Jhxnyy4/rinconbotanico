		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total last-item">Ir</th>
				</tr>
			</thead><!-- /thead -->
...
?>
				<tr>
					...
					<td class="cart-product-sub-total">$<?php echo $shippcharge=$row['shippingcharge']; ?> MXN</td>
					<td class="cart-product-grand-total">$<?php echo (($qty*$price)+$shippcharge);?> MXN</td>
