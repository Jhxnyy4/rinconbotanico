	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Seguimiento del pedido</li>
			</ul>
...
<div class="body-content outer-top-bd">
	...
	<span class="title-tag inner-top-vs">Introduzca su número de pedido en la casilla siguiente y pulse INTRO. Este número figura en su recibo y en el correo electrónico de confirmación que debería haber recibido. </span>
	<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
		<div class="form-group">
		    <label class="info-title" for="exampleOrderId1">Clave del pedido</label>
