...
?>
						...
						<div class="rating">
							...
							<span class="review">( <?php echo htmlentities($num);?> Vistas )</span>
						</div>
						<?php } ?>
						<div class="price">MXN. 
					...
					<td class="col-md-2 close-btn">
						<a href="my-wishlist.php?del=<?php echo htmlentities($row['wid']);?>" onClick="return confirm('¿Estás seguro de que quieres eliminar esté producto de tu lista de favoritos?')" class=""><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Tu lista de favoritos está vacía</td>
