...
echo "<script>alert('Algo salió mal al registrarse');</script>";
}
}
// Code for User login
...
header("location:http:/rinconbotanico/index.php");
exit();
}
else
{
...
<html lang="en">
	<head>
	    ...
	    <title>Rincón botánico | inicio de sesión</title>
...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<p class="">Ingresa tu cuenta para seguir haciendo tus compras.</p>
...
?>
		...
		<div class="radio outer-xs">
		  	<a href="forgot-password.php" class="forgot-password pull-right">¿Has olvidado tu contraseña?</a>
		</div>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Cree su propia cuenta para realizar sus compras.</p>
...
<div class="form-group">
	...
	<span class="checkout-subtitle outer-top-xs">Regístrese hoy mismo y podrá: </span>
	<div class="checkbox">
	  	<label class="checkbox">
		Realizar compras seguras
	</label>
		<label class="checkbox">
		Seguir sus pedidos fácilmente.		
	</label>
		<label class="checkbox">
		Llevar un registro de todas sus compras.		</label>
	</div>
</div>	
