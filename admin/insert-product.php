...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Ingresa el vivero en el que pertenece el producto" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Ingresa el precio con descuento" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingresa el costo de envío por el producto" class="span8 tip" required>
</div>
</div>
