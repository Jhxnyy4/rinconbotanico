...
$_SESSION['msg']="Imagen del producto actualizada correctamente!!";
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar imagen 1 del producto</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen 1 nuevo</label>
<div class="controls">
