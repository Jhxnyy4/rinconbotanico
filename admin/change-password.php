...
{
alert("Confirmación de contraseña nueva está vacía!!");
...
<div class="controls">
<input type="password" placeholder="Introduzca su nueva contraseña"  name="newpassword" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="password" placeholder="Confirmar su nueva contraseña"  name="confirmpassword" class="span8 tip" required>
</div>
</div>
