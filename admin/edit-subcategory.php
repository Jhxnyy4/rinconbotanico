...
<div class="controls">
<input type="text" placeholder="Ingresar nombre de la subcategoria"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
