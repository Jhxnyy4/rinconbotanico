...
<div class="controls">
<input type="text"    name="productName"  placeholder="Ingresa el nombre del producto" value="<?php echo htmlentities($row['productName']);?>" class="span8 tip" >
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Vivero</label>
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Ingresa el vivero en el que pertenece el producto" value="<?php echo htmlentities($row['productCompany']);?>" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Precio normal del producto</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Ingresa el precio del producto" value="<?php echo htmlentities($row['productPriceBeforeDiscount']);?>"  class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Precio del producto con descuento</label>
<div class="controls">
<input type="text"    name="productprice"  placeholder="Ingresa el precio con descuento" value="<?php echo htmlentities($row['productPrice']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingresa el costo de envío por el producto" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>
